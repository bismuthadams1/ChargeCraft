...
def main():
    ...
    PROP_DIR = '/Users/localadmin/Documents/molesp_test'
    ...
    esp_settings = ESPSettings(basis="6-31G*", method="hf", grid_settings=MSKGridSettings())
    ...
    for mol in smiles:
        ...
        ESP_gen = PropGenerator(molecule = molecule, conformers = conformer_list, esp_settings = esp_settings, grid_settings = MSKGridSettings(), prop_data_store = MoleculePropStore(database_path='surface_database.db'))
